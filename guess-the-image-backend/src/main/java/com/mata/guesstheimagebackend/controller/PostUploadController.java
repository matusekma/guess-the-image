...
import com.mata.guesstheimagebackend.service.BlobStorageService;
...
public class PostUploadController {
    ...
    public PostUploadController(BlobStorageService blobStorageService, PostService postService) {
        this.storageService = blobStorageService;
